...
<body>
                ...
                <div class="container">
                    <ul class="quick-menu pull-left">
                        ...
                        <li class="ribbon">
                            <a href="#">Español</a>
                            <ul class="menu mini">                               
                               <li><a href="en/index1.html" title="Inglés">Inglés</a></li>
                        ...
                        <ul class="menu">
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    ...
                                    <li><a href="terminos-de-usos.html">TERMINOS DE USOS</a></li>
                                </ul>
                            </li>
                            <li class="menu-item-has-children">
    ...
    <script type="text/javascript">
        tjq(".travelo-google-map").gmap3({
            map: {
                options: {
                    center: [10.992682, -63.826070],
                    zoom: 12
                }
            },
            marker: {
                values: [
                    { latLng: [10.992682, -63.826070], data: "Venezuela" }
